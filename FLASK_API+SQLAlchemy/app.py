...
class ProductSchema(ma.Schema):
    class Meta:
        fields = ('id', 'customer', 'description', 'price', 'quantity') # fields i want to show.
...
# Update a Product. 'PUT' request handles any updates in the server
